...
<div class="container-fluid">
	...
	<div class="col-md-6">
	    ...
	    <img class='user' src='image/1.png' alt='logo'/>
					...
					<?php	echo"<p>série:".$id ; echo"</p>"; ?>
					</strong>
			 		<SCRIPT>
                        document.write("Date de resérvation : " + document.lastModified)
                    </SCRIPT></br>
	
			 		<?php	echo"<p>Date Depart : ".$var2  ; echo"</p>";?>
 ...
 <a href="dompdf1.php">Telecharger PDF</a> </div>
	   ...
	   <!-- ......................................................................... -->
	<?php
 $res= mysqli_query($link,"SELECT * FROM `deplacement` WHERE idDeplacement=$id ");
				 echo"<div>";
				 echo"<table  border=1>";
				 echo"<tr>";
	 ...
	 ?>
   <div class="retour">	 
 <a href=" billet3.php">  billet de retour </a>
 </div>
	   	               <!-- ............................................................................... -->
