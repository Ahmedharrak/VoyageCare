...
$_SESSION['prenom']=$_POST['prenom'];
 ...
 $huer=$_SESSION['huer'];
	 $idd=$_SESSION['iddep'];
	$date1= $_SESSION['party2'];
	  $date2= $_SESSION['party3'];
			...
			<div class="panel-body">
				<div class="row">
	               ...
	               <!-- ............................................................................... -->
				   				   ...
				   				   <form action="billet2.php" method="POST" >
								   <div class="code">
...
<?php
	     if(isset($_POST["Reserver"])){
		  ...
		  mysqli_query($link,"INSERT INTO `client`( `Nom`, `Prenom`, `idDeplacement`, `Numero`, `Gmail`, `Gsm`, `Nbplace`,`date`,`heure`,`numeroCarte`) VALUES ('$_POST[nom]','$_POST[prenom]','$id','$_POST[CIN]','$_POST[mail]','$_POST[tel]','$sum','$date1','$heure','$_POST[cartebancaire]')");
		   mysqli_query($link,"INSERT INTO `reservation`( `idDeplacement`, `date`, `heure`, `place`) VALUES('$idd',' $date2',' $huer','$su')");
	 }
